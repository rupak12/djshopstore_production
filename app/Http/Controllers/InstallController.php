...
class InstallController extends Controller
{
    ...
    public function purchase_code(Request $request) {
        // Skip purchase code validation
        Session::put('purchase_code', 'dummy_purchase_code');
        $this->writeEnvironmentFile('SYSTEM_KEY', 'dummy_system_key');
