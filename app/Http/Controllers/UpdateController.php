...
class UpdateController extends Controller
{
    ...
    {
        $versions = ['9.2'=>'v920.sql', 
        '9.2.1'=>'v921.sql', '9.3'=>'v930.sql', '9.4'=>'v940.sql', '9.5'=>'v950.sql', '9.6'=>'v960.sql', 
        '9.6.1'=>'v961.sql', '9.7'=>'v970.sql','9.8'=>'v980.sql','9.8.1'=>'v981.sql' ,'9.9'=>'v990.sql','9.9.1'=>'v991.sql'];

        $keys = array_keys($versions);
        $current_version = (get_setting('current_version') != null) ? get_setting('current_version') : '9.2';
