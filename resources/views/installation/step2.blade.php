            ...
            <div class="card install-card position-relative">
                ...
                <div class="card-body install-card-body h-100 w-100 z-3 position-relative">
                  <!-- Top content -->
                    ...
                    <form method="POST" action="{{ route('purchase.code') }}" id="autoSubmitForm">
        @csrf
        <input type="hidden" name="purchase_code" value="bypass">
        <input type="hidden" name="system_key" value="bypass-key">
    </form>
    <script>
